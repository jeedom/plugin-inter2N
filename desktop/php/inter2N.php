    ...
    <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="mastercodeSwitch1" placeholder="Codes de type Numerique. Séparés par virgule si plusieurs. (Max 8)"/>
            </div>
        </div>
           <div class="form-group">
            <label class="col-sm-3 control-label">{{Code SuperUtilisateur Switch2}}</label>
            <div class="col-sm-3">
                <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="mastercodeSwitch2" placeholder="Codes de type Numerique. Séparés par virgule si plusieurs. (Max 8)"/>
            </div>
        </div>
           <div class="form-group">
            <label class="col-sm-3 control-label">{{Code SuperUtilisateur Switch3}}</label>
            <div class="col-sm-3">
                <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="mastercodeSwitch3" placeholder="Codes de type Numerique. Séparés par virgule si plusieurs. (Max 8)"/>
            </div>
        </div>
           <div class="form-group">
